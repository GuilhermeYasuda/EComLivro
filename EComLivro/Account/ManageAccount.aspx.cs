    ...
    public partial class ManageAccount : ViewGenerico
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ClientePFXEndereco clientePFXEndereco = commands["CONSULTAR"].execute(new ClientePFXEndereco() { ID = cliente.ID } ).Entidades.Cast<ClientePFXEndereco>().ElementAt(0);
        ...
        protected void AlterUser_Click(object sender, EventArgs e)
        {
            ...
            // -------------------------- DADOS ENDEREÇO COMEÇO --------------------------------------
            string idEndereco = txtIdEndereco.Text.Trim();
            ...
            endereco.ID = Convert.ToInt32(idEndereco);
