<%@ Page Title="Logon" Language="C#" MasterPageFile="~/Loja/MastePageLoja.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EComLivro.Account.Login" Async="true" %>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <section id="loginForm">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-10">
                                    <asp:Button runat="server" OnClick="LogIn" Text="Logon" CssClass="btn amado-btn" />
                                </div>
                            </div>
                        </div>
                        <p>
