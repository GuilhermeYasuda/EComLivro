<%@ Page Title="" Language="C#" MasterPageFile="~/Adm/MasterPageAdm.Master" AutoEventWireup="true" CodeBehind="CadastroEndereco.aspx.cs" Inherits="EComLivro.Adm.CadastroEndereco" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title>ÉComLivro - Cadastro de Endereço</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li id="idBreadCrumb" runat="server" class="breadcrumb-item active">Cadastro de Endereço</li>
        </ol>
